...
PyTorch also has packages that making deep learning possible such as automatic differentiation and gradient based optimization.  PyTorch also has utility packages for loading in data and pre-trained models.
